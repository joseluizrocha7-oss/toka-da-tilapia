...
name: abrir
description: >
  Abre uma sessão de trabalho carregando a memória da agência (empresa, preferências, estratégia, identidade)
  e devolve um resumo curto pro usuário. Use quando o usuário disser "abrir",
  "começar o dia", "/abrir" ou no primeiro turno de uma sessão.
---
...
```
Rocha Digital Studio — [o que faz em 5-8 palavras]
Foco atual: [prioridade da estratégia, em uma frase]
Tom: [resumo de 3-4 palavras do tom de voz]
Clientes ativos: [N clientes — lista em uma linha]
